...
- [ ] **Features (release V6?):**
  ...
  - [ x ] Error handling to prevent lose data, lose connections, or temporary downtimes
  - [ x ] Reduce Server and Client load by optimizing the code (code size, number of instructions, use of correct collections, ...)
